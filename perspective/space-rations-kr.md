...
* AI 보조 개발은 숭배할 교리가 아니라, 임무에 맞춰 꺼내 쓰는 우주 전투식량(Space Rations)이다.
...
이 말은 언뜻 무관심한 것처럼 들리지만, 자신의 주관적 기준과 판단을 잠시 미루는 행위이다. 그래야 상대의 세계가 왜곡 없이 모습을 드러내기 시작한다.
...
그래서 AI 보조 개발의 핵심 질문은 AI를 믿을 것인가, 의심할 것인가에 머물지 않는다.
...
문제는 특정 기술 스택이 아니다.\
문제는 특정 언어, 특정 프레임워크, 혹은 vibe coding 자체에 있지 않다.
...
AI 보조 개발을 기본값으로 Wrong이라고 낙인찍는 조직에 필요한 것은 무조건적인 개방이 아니다.
...
기술을 교리로 만들지 않는다는 말은 아무 규칙 없이 표류한다는 뜻이 아니다.
