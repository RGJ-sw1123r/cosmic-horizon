...
* 이 궤도에서 나온 초기 실물 산출물을 확인하려면 [Codex Chat Viewer](https://github.com/revertable/codex-chat-viewer)를 살펴봅니다. Codex CLI 세션 로그를 관측, 검토, 문서화하고 다시 돌아보기 위해 구축한 로컬 우선(local-first) 뷰어입니다. 이후 Codex Chat Viewer를 계승하는 새 버전으로 [Codex JSONL Observatory](https://github.com/revertable/codex-jsonl-observatory)가 공개되었습니다. Codex CLI JSONL 세션을 읽고, 작업 흐름을 `[YOU]` 요청 단위의 버전 관리 가능한 worklog bundle로 내보내는 로컬 데스크톱 도구입니다.
