---
description: >-
  AI가 코드를 쓰는 시대에 인간이 무엇을 판단하고, 어디에 경계를 세우며, 무엇을 검증하고 책임져야 하는지 기록하는 엔지니어링
  아카이브입니다.
---
...
이 아카이브의 많은 기록은 case-driven 방식으로 움직입니다.

먼저 현장의 마찰, 실험, 대화, 도구 사용, 실패가 관측됩니다.\
그 관측은 문장으로 압축되고, 다시 운영 모델, protocol, case, template, record로 분기됩니다.
